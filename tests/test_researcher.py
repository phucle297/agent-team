...
class TestResearcher:
    @patch("agents.researcher.get_google")
    def test_returns_research_from_llm(self, mock_get_google):
        mock_llm = MagicMock()
    ...
    @patch("agents.researcher.get_google")
    def test_includes_plan_in_prompt(self, mock_get_google):
        mock_llm = MagicMock()
    ...
    @patch("agents.researcher.get_google")
    def test_handles_empty_plan(self, mock_get_google):
        mock_llm = MagicMock()

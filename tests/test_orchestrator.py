...
class TestOrchestrator:
    ...
    def test_returns_sub_tasks_list(self, mock_get_llm):
    ...
    @patch("agents.orchestrator.get_llm")
    def test_sets_plan_from_sub_tasks(self, mock_get_llm):
        from agents.orchestrator import orchestrator
    ...
    @patch("agents.orchestrator.get_llm")
    def test_handles_invalid_json_gracefully(self, mock_get_llm):
        from agents.orchestrator import orchestrator
    ...
    @patch("agents.orchestrator.get_llm")
    def test_handles_markdown_fenced_json(self, mock_get_llm):
        from agents.orchestrator import orchestrator
    ...
    @patch("agents.orchestrator.get_llm")
    def test_includes_project_context_in_prompt(self, mock_get_llm):
        from agents.orchestrator import orchestrator
    ...
    @patch("agents.orchestrator.get_llm")
    def test_caps_sub_tasks_at_max(self, mock_get_llm):
